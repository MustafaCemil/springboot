								...
								<div class="widget-shadow " data-example-id="basic-forms"> 
									...
									<div class="form-body">
										...
										<div class="form-group"> 
												...
												<div class="col-sm-9"> 
													<form:input type="text" value="" path="cityname" class="form-control" id="inputEmail3" placeholder="CityName"/> 
												</div> 
											</div> 			
										

											<div class="col-sm-offset-2"> 
												<form:button type="submit" name="submit" class="btn btn-default w3ls-button">Create City</form:button> 
											</div> 
										</form:form> 
									</div>
								</div>
